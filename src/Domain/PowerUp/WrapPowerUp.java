...
public class WrapPowerUp extends PowerUp {
	...
	public WrapPowerUp(int xLoc, int yLoc) {
		super(xLoc, yLoc);
		this.type = "WrapPowerUp";
		try {
			super.Image = ImageIO.read(new FileImageInputStream(new File("Assets/Wrap_Power_Up.png")));
		}
		catch(IOException ex) {
			Logger.getLogger(WrapPowerUp.class.getName()).log(Level.SEVERE,null,ex);
		}
	}
